package eu.krzdabrowski.currencyadder.totalsavings.presentation.tests

import androidx.compose.ui.test.junit4.createComposeRule
import androidx.compose.ui.test.onNodeWithText
import androidx.compose.ui.test.performClick
import eu.krzdabrowski.currencyadder.exchangerates.domain.data.dummy.generateTestCurrencyCodesFromPresentation
import eu.krzdabrowski.currencyadder.totalsavings.domain.data.dummy.generateTestChosenCurrencyCodeForTotalSavingsFromPresentation
import eu.krzdabrowski.currencyadder.totalsavings.domain.data.dummy.generateTestTotalUserSavingsFromPresentation
